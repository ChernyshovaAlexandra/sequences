...
__export(index_exports, {
  ...
  useSequenceGame: () => useSequenceGame,
  useSequenceStore: () => useSequenceStore
});
...
// src/hooks/useSequenceGame.tsx
var import_react = require("react");

// src/store/useSequenceStore.ts
var import_zustand = require("zustand");
var useSequenceStore = (0, import_zustand.create)()((set) => ({
  order: [],
  score: 0,
  timer: null,
  grid: [],
  remaining: [],
  setOrder: (value) => set((state) => ({
    order: typeof value === "function" ? value(state.order) : value
  })),
  setScore: (v2) => set((s2) => ({
    score: typeof v2 === "function" ? v2(s2.score) : v2
  })),
  setGrid: (value) => set((state) => ({
    grid: typeof value === "function" ? value(state.grid) : value
  })),
  setRemaining: (value) => set((state) => ({
    remaining: typeof value === "function" ? value(state.remaining) : value
  })),
  startTimer: (sec) => set({ timer: sec }),
  tick: () => set((s2) => s2.timer === null ? {} : { timer: Math.max(0, s2.timer - 1) })
}));

// src/logic/handleDrop.ts
var createHandleDrop = (setGrid, setRemaining, setScore) => {
  return (e, cellIndex) => {
    e.preventDefault();
...
// src/logic/handleReturnCard.ts
var createHandleReturnCard = (setGrid, setRemaining) => {
  return (card) => {
    setGrid((prevGrid) => {
      const gridCopy = [...prevGrid];
      setRemaining((prevRemaining) => {
...
// src/logic/isCardOrderCorrect.ts
var isCardOrderCorrect = (grid) => {
  if (grid.some((cell) => !cell)) return false;
  for (let i2 = 1; i2 < grid.length; i2++) {
    const prev2 = grid[i2 - 1]?.id;
    const curr = grid[i2]?.id;
    if (!prev2 || !curr || curr <= prev2) return false;
  }
  return true;
};

// src/hooks/useSequenceGame.tsx
var useSequenceGame = (items, timer) => {
  const { score, setScore, grid, remaining, setGrid, setRemaining } = useSequenceStore();
  const [remainingTime, setRemainingTime] = (0, import_react.useState)(timer);
  ...
  const handleReturnCard = (0, import_react.useCallback)(
    createHandleReturnCard(setGrid, setRemaining),
    [setGrid, setRemaining]
  );
  const isCardOrderCorrect2 = (0, import_react.useCallback)(() => isCardOrderCorrect(grid), [grid]);
  ...
  (0, import_react.useEffect)(() => {
    ...
    const interval = setInterval(() => {
      setRemainingTime((prev2) => {
        if (prev2 === void 0) return void 0;
        if (prev2 <= 1) {
  ...
  (0, import_react.useEffect)(() => {
    console.log("\u{1F3AF} \u041D\u043E\u0432\u044B\u0439 \u0441\u0447\u0451\u0442:", score);
  }, [score]);
  return {
    handleDrop,
    handleDragOver,
    handleReturnCard,
    isCardOrderCorrect: isCardOrderCorrect2,
    remainingTime,
    gridCells: grid,
...
function Xe(e, t, n, o2) {
  ...
  if (re(e)) {
    ...
    var r2 = e(t);
    return "production" === process.env.NODE_ENV || "object" != typeof r2 || Array.isArray(r2) || r2 instanceof qe || ce(r2) || null === r2 || console.error("".concat(B(e), " is not a styled component and cannot be referred to via component selector. See https://www.styled-components.com/docs/advanced#referring-to-other-components for more details.")), Xe(r2, t, n, o2);
  }
  var s2;
...
function it(e, r2, s2) {
  ...
  function O2(e2, r3) {
    return function(e3, r4, s3) {
      ...
      "production" !== process.env.NODE_ENV && (0, import_react2.useDebugValue)(d2);
      ...
      var E3 = function(e4, t) {
        ...
        return "production" !== process.env.NODE_ENV && (0, import_react2.useDebugValue)(o2), o2;
      }(a3, g3);
...
var Zone = dt.div`
  ...
  flex-wrap: wrap;
`;
var BottomZone = ({ cards, Card }) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Zone, { children: cards.map((c2) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Card, { value: c2.value }, c2.id)) });
...
var CardBox = dt.div`
  ...
  user-select: none;
`;
var DefaultCard = (0, import_react3.memo)(({ value, isDragging }) => /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(CardBox, { $drag: isDragging, children: value }));

// src/components/DefaultPanel.tsx
var import_jsx_runtime3 = require("react/jsx-runtime");
var PanelWrap = dt.div`
  display: flex;
  gap: 12px;
  margin-bottom: 32px;
`;
var DefaultPanel = ({ slots, Card }) => /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(PanelWrap, { children: slots.map(
  (slot, idx) => slot ? /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(Card, { value: slot.value }, slot.id) : /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(
    "div",
    {
      style: {
        width: 80,
...
var DraggableCard = (0, import_react4.memo)(
...
// src/SequenceGame.tsx
var import_jsx_runtime5 = require("react/jsx-runtime");
var SequenceGame = ({
  items,
  cardComponent: Card = void 0,
  // cx,
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)("div", { children: [
    remainingTime !== void 0 && (TimerComponent ? /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(
      TimerComponent,
      {
        timer: remainingTime,
        formattedTimer: timerFormat === "MMSS" ? formatTime(remainingTime) : remainingTime
      }
    ) : /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("div", { children: timerFormat === "MMSS" ? formatTime(remainingTime) : remainingTime })),
    /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("div", { style: { display: "flex", gap: "10px" }, children: gridCells?.map((cell, index) => /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(
      "div",
      {
        ...
        children: cell && /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(
          DraggableCard,
          {
            index,
            card: cell,
    ...
    /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("div", { style: { marginTop: 20, display: "flex", gap: "10px" }, children: remainingCardImages?.map((card, index) => /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(
      "div",
      {
        ...
        children: card && /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(
          DraggableCard,
          {
            index,
            card,
