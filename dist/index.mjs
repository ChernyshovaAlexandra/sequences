...
var useSequenceStore = create()((set) => ({
  order: [],
  score: 0,
  timer: null,
  grid: [],
...
var useSequenceGame = (items, timer) => {
  ...
  const isCardOrderCorrect2 = useCallback(() => isCardOrderCorrect(grid), [grid]);
  useEffect(() => {
...
var Me = new ke();
var ze = Fe();
var $e = o.createContext({ shouldForwardProp: void 0, styleSheet: Me, stylis: ze });
var Be = $e.Consumer;
...
function Ye(e) {
  var t = s(e.stylisPlugins), n = t[0], r2 = t[1], c2 = Ge().styleSheet, l2 = i(function() {
    var t2 = c2;
  ...
  }, [e.disableCSSOMInjection, e.sheet, e.target, c2]), u2 = i(function() {
  ...
  return o.createElement($e.Provider, { value: d }, o.createElement(Le.Provider, { value: u2 }, e.children));
}
var qe = function() {
  function e(e2, t) {
    var n = this;
...
function it(e, r2, s2) {
  ...
  function O2(e2, r3) {
    return function(e3, r4, s3) {
      var i3 = e3.attrs, a3 = e3.componentStyle, c3 = e3.defaultProps, p3 = e3.foldedComponentIds, d2 = e3.styledComponentId, h2 = e3.target, f3 = o.useContext(et), m3 = Ge(), y3 = e3.shouldForwardProp || m3.shouldForwardProp;
      "production" !== process.env.NODE_ENV && l(d2);
      ...
      var E3 = function(e4, t) {
        ...
        return "production" !== process.env.NODE_ENV && l(o2), o2;
      }(a3, g3);
...
var gt = function() {
  ...
  return e.prototype.collectStyles = function(e2) {
    ...
    if (this.sealed) throw he(2);
    this.seal();
    var t = __require("stream").Transform, n = e2, o2 = this.instance, r2 = this._emitSheetCSS, s2 = new t({ transform: function(e3, t2, n2) {
...
var Zone = dt.div`
  ...
  flex-wrap: wrap;
`;
var BottomZone = ({ cards, Card }) => /* @__PURE__ */ jsx(Zone, { children: cards.map((c2) => /* @__PURE__ */ jsx(Card, { value: c2.value }, c2.id)) });
...
var CardBox = dt.div`
  ...
  user-select: none;
`;
var DefaultCard = memo(({ value, isDragging }) => /* @__PURE__ */ jsx2(CardBox, { $drag: isDragging, children: value }));
...
var PanelWrap = dt.div`
  ...
  margin-bottom: 32px;
`;
var DefaultPanel = ({ slots, Card }) => /* @__PURE__ */ jsx3(PanelWrap, { children: slots.map(
  (slot, idx) => slot ? /* @__PURE__ */ jsx3(Card, { value: slot.value }, slot.id) : /* @__PURE__ */ jsx3(
    "div",
    {
      style: {
        width: 80,
...
var SequenceGame = ({
  ...
  return /* @__PURE__ */ jsxs("div", { children: [
    remainingTime !== void 0 && (TimerComponent ? /* @__PURE__ */ jsx5(
      TimerComponent,
      {
        timer: remainingTime,
        formattedTimer: timerFormat === "MMSS" ? formatTime(remainingTime) : remainingTime
      }
    ) : /* @__PURE__ */ jsx5("div", { children: timerFormat === "MMSS" ? formatTime(remainingTime) : remainingTime })),
    /* @__PURE__ */ jsx5("div", { style: { display: "flex", gap: "10px" }, children: gridCells?.map((cell, index) => /* @__PURE__ */ jsx5(
      "div",
      {
    ...
    /* @__PURE__ */ jsx5("div", { style: { marginTop: 20, display: "flex", gap: "10px" }, children: remainingCardImages?.map((card, index) => /* @__PURE__ */ jsx5(
      "div",
      {
